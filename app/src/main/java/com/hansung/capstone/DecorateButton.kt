...
class DecorateButton(private val binding: BoardFragment) {
    fun decoTotalBt() {
        ...
        binding.courseCategory.background =
            ContextCompat.getDrawable(binding.requireContext(), R.drawable.normal_border)
        binding.totalCategory.background =
            ContextCompat.getDrawable(binding.requireContext(), R.drawable.press_border)
        binding.freeCategory.background =
            ContextCompat.getDrawable(binding.requireContext(), R.drawable.normal_border)
    }
